...
{  question: "18. Which key is used to open the 'Save As' dialog box in MS Word?",  options: ["F12", "Ctrl + S", "Alt + F4", "Ctrl + P"], answer: "F12" }, 
  ...
  "excel": [
    ...
    { question: "5. How many columns are there in an Excel sheet?", options: ["16384", "1048576", "256", "65536"], answer: "16384" },
    ...
    { question: "12. What is the shortcut key to Save a file?", options: ["Ctrl + S", "Ctrl + A", "Ctrl + P", "Ctrl + C"], answer: "Ctrl + S" },
    ...
    { question: "16. What is the shortcut to make text Bold?", options: ["Ctrl + B", "Ctrl + I", "Ctrl + U", "Ctrl + A"], answer: "Ctrl + B" },
    ...
    { question: "21. Which tab is used to change Page Orientation?", options: ["Home", "Insert", "Page Layout", "View"], answer: "Page Layout" },
    { question: "22. What is the shortcut to Autosum?", options: ["Alt + =", "Ctrl + =", "Shift + =", "Alt + S"], answer: "Alt + =" },
    { question: "23. Which key moves to the previous cell?", options: ["Tab", "Shift + Tab", "Enter", "Space"], answer: "Shift + Tab" },
    ...
    { question: "25. What is the shortcut to Copy a cell?", options: ["Ctrl + C", "Ctrl + V", "Ctrl + X", "Ctrl + Z"], answer: "Ctrl + C" },
    { question: "26. Where is the Cell Address shown?", options: ["Formula Bar", "Status Bar", "Name Box", "Title Bar"], answer: "Name Box" },
    { question: "27. What is the shortcut to 'Find' text?", options: ["Ctrl + F", "Ctrl + G", "Ctrl + H", "Ctrl + P"], answer: "Ctrl + F" },
    { question: "28. Shortcut for 'Current Time'?", options: ["Ctrl + Shift + :", "Ctrl + ;", "Alt + T", "Ctrl + T"], answer: "Ctrl + Shift + :" },
    { question: "29. What is the shortcut to 'Cut' a cell?", options: ["Ctrl + X", "Ctrl + C", "Ctrl + V", "Ctrl + A"], answer: "Ctrl + X" },
